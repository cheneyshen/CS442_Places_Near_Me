...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.example.fshen4.CS442_Places_Near_Me.R.layout.activity_launcher);
		try {
    ...
    public void searchPlaces(View v)
    {
    	...
    	EditText searchType = (EditText) findViewById(com.example.fshen4.CS442_Places_Near_Me.R.id.search_type);
    	EditText searchRadius = (EditText) findViewById(com.example.fshen4.CS442_Places_Near_Me.R.id.search_radius);
