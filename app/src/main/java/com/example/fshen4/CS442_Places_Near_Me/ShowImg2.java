...
public class ShowImg2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.example.fshen4.CS442_Places_Near_Me.R.layout.showimg2);
		
		ImageView img = (ImageView) findViewById(com.example.fshen4.CS442_Places_Near_Me.R.id.imageView1);
		img.setBackgroundResource(com.example.fshen4.CS442_Places_Near_Me.R.drawable.bg115);
	}
